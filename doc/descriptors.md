# Support for Output Descriptors in Telnetcoin Core

Since Telnetcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Telnetcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Telnetcoin Core wallets, a convenience function `combo` is
