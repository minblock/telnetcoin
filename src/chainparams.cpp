...
public:
    CMainParams() {
        ...
        assert(genesis.hashMerkleRoot == uint256S("0xa4cc96c7f8e3aa9c19ec7213d34fd172a5a0ab56c5b9a7b2e2f945098ec810cf"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  7881, uint256S("0xb0093c9696bc4db56a097b894663915bb07fb7f3f59bc5e7e6458f129cdddb5b"))
        };

        chainTxData = ChainTxData{
            // Data as of block b44bc5ae41d1be67227ba9ad875d7268aa86c965b1d64b47c35be6e8d5c352f4 (height 1155626).
            1635486015, // * UNIX timestamp of last known number of transactions
            8208,  // * total number of transactions between genesis and that timestamp
                    //   (the tx=... number in the SetBestChain debug.log lines)
            0.91     // * estimated number of transactions per second after that timestamp
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("telnetcointools.com", "testnet-seed.telnetcointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.telnetcoin.loshan.co.uk", true));
