...
public:
    CMainParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.telnetcoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("telnetcointools.com", "dnsseed.telnetcointools.com"));
        //vSeeds.push_back(CDNSSeedData("telnetcoinpool.org", "dnsseed.telnetcoinpool.org"));
