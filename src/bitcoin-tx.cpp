...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " telnetcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  telnetcoin-tx [options] <hex-tx> [commands]  Update hex-encoded telnetcoin transaction\n" +
            "or:     telnetcoin-tx [options] -create [commands]   Create hex-encoded telnetcoin transaction\n" +
            "\n";
