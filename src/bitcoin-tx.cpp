...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s telnetcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  telnetcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded telnetcoin transaction") + "\n" +
              "  telnetcoin-tx [options] -create [commands]   " + _("Create hex-encoded telnetcoin transaction") + "\n" +
              "\n";
