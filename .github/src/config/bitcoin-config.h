...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Telnetcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Telnetcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/telnetcoin-project/telnetcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Telnetcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Telnetcoin Core 0.16.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "telnetcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://telnet.provigen.net/"
