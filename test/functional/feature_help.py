...
"""Verify that starting telnetcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start telnetcoin with -h for help text")
        ...
        self.log.info("Start telnetcoin with -version for version information")
        ...
        self.log.info("Start telnetcoind with -fakearg to make sure it does not start")
